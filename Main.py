...
# आपके ब्लॉगर क्रेडेंशियल्स जो आपने GitHub Secrets में सेट किए होंगे
...
def get_existing_posts():
    ...
    if not BLOG_ID or not API_KEY:
        print("Warning: BLOGGER_BLOG_ID or BLOGGER_API_KEY not found in environment variables.")
...
def post_to_blogger(title, content, labels):
    ...
    # यहाँ आपका ब्लॉगर API पोस्टिंग का लॉजिक काम करेगा
...
def scrape_sarkari_result():
    ...
    try:
        ...
        # यहाँ पर सिंटैक्स एरर को पूरी तरह ठीक कर दिया गया है (id='post' फॉर्मेट में)
        sections = {
            'Latest Jobs': soup.find(id='post'), 
        ...
        for link in all_links:
            ...
            # सिर्फ काम के जॉब लिंक्स निकालने के लिए फ़िल्टर
            ...
            if title_text.lower() not in existing_titles:
                # पोस्ट का सुंदर फॉर्मेट (बटन और आपके चैनल के नाम के साथ)
                post_content = f"""
                ...
                <div style="text-align: center;">
                    <a href="{href}" style="background-color: #008CBA; color: white; padding: 10px 20px; text-decoration: none; border-radius: 5px; font-weight: bold; display: inline-block;">Click Here for Full Details & Table</a>
                </div>
                <br>
                ...
                print(f"Successfully processed new post: {title_text}")
            else:
